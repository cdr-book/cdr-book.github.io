...
Dos estimadores no paramétricos de la función de intensidad ampliamente utilizados en patrones puntuales en \(\mathbb R^2\), basados en **funciones núcleo**\index{función!nucleo@{núcleo}}, vienen dados por:
\begin{equation}
...
### Características de segundo orden: la función $K$ de Ripley

\index{características! de segundo orden}
...
## Patrones puntuales espaciales sobre redes lineales\index{red!lineal} {#seclineal}
