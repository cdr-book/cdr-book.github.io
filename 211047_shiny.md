...
\caption{Mi primer Shiny: evolución del paro regisrado en Castilla-La Mancha (España) por tramos de edad (sidebarPanel en la izquierda, por defecto).}(\#fig:izda)
\end{figure}
...
\caption{Aplicación Shiny con sidebarPanel a la derecha: evolución del paro regisrado en Castilla-La Mancha (España) por tramos de edad.}(\#fig:dcha)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{img/fig3} 

}

\caption{Aplicación Shiny con varias pestañas: evolución del paro regisrado en Castilla-La Mancha (España) por tiempo de búsqueda de empleo.}(\#fig:sh-ventanas)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{img/entradas3} 

}

\caption{Distintos elementos para la introducción de datos.}(\#fig:sh-intro-datos)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{img/sust} 

}

\caption{Lectura de datos.}(\#fig:shiny-lee)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{img/react2} 

}

\caption{Control de la reactividad en un histograma.}(\#fig:sh-react)
\end{figure}
