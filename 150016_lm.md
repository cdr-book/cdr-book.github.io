...
En la práctica, el coeficiente estimado es *significativo* si su *p*--valor\index{p-valor@\textit{p} valor} (definido en la Sec. \@ref(contrhip)) asociado es suficientemente pequeño.
...
{\centering \includegraphics[width=0.6\linewidth]{150016_lm_files/figure-latex/lm-airQlmsimples-1} 

}

\caption{Gráficos de dispersión de las variables explicativas frente a la variable respuesta.}(\#fig:lm-airQlmsimples)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150016_lm_files/figure-latex/lm-residuosOzone-1} 

}

\caption{Gráficos de residuos.}(\#fig:lm-residuosOzone)
\end{figure}
...
{\centering \includegraphics[width=0.4\linewidth]{150016_lm_files/figure-latex/lm-histogramas-1} 

}

\caption{Histogramas de las variables $Ozone$ y $log(Ozone)$.}(\#fig:lm-histogramas)
\end{figure}
...
{\centering \includegraphics[width=0.4\linewidth]{150016_lm_files/figure-latex/lm-airQpairs-1} 

}

\caption{Gráfico de dispersión por pares de las variables explicativas.}(\#fig:lm-airQpairs)
\end{figure}
