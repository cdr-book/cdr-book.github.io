...
**riesgo de reincidir con violencía**. La Tabla \@ref(tab:tab1etica) resume las principales conclusiones obtenidas en el estudio de PROPUBLICA.
...
<div class="figure" style="text-align: center">
<img src="img/algoritmosexplicabilidad.png" alt="Interpretabilidad $vs.$ exactitud." width="60%" />
...
-   La libería `fairness`[^eti3] [^eti4]: incluye algoritmos para detectar el sesgo, pero también para mitigarlo. Explica las distintas
...
-  La libería `EDFfair`[^eti5]: tiene una aproximación distinta, dado
