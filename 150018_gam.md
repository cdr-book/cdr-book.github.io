...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/psplines-1} 

}

\caption{Regresión con $P$-$splines$  para diferentes valores del parámetro de suavizado.}(\#fig:psplines)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/tsfossil-1} 

}

\caption{Edad de los fósiles con respecto a la proporción de isótopos de estroncio.}(\#fig:tsfossil)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{img/gam_check} 

}

\caption{Gráficos de residuos obtenidos con $gam.check().$ }(\#fig:fig8)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/fig9-1} 

}

\caption{Curva ajustada e intervalo de confianza.}(\#fig:fig9)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/fig18-1} 

}

\caption{Curvas estimadas para $Wind$, $Temp$ y $Solar$. }(\#fig:fig18)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/fig20-1} 

}

\caption{Curvas ajustadas para ambas localidades.}(\#fig:fig20)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/fig21-1} 

}

\caption{Curvas ajustadas para ambas localidades permitiendo que no sean paralelas.}(\#fig:fig21)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/fig27-1} 

}

\caption{Área donde se constató la ausencia/presencia de huevos de jurel.}(\#fig:fig27)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{150018_gam_files/figure-latex/fig22-1} 

}

\caption{Efectos suaves estimados por el modelo para las variables. Efecto de la profundidad y temperatura en la fila superior y efecto espacial en la inferior.}(\#fig:fig22)
\end{figure}
