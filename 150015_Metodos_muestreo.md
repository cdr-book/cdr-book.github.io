...
### Ejemplo de m.a.s. {#ejemMAS}

Para ejemplificar el proceso de obtención de una muestra aleatoria simple en **R**, se usará el paquete `samplingbook` y el conjunto de datos `iris`, correspondiente a las medidas, en centímetros, de largo y ancho de los sépalos y pétalos de 150 flores, equidistribuidas entre las especias *setosa*, *versicolor* y *virginica*.
...
Así, con el método bootstrap, no es necesario asumir ninguna distribución en el muestreo. Aún así, la representación gráfica de la distribución empírica de los valores medios remuestreados y los extremos del intervalo de confianza (Fig. \@ref(fig:150015dist)), muestra cómo la distribución de las remuestras sobre el estadístico se asemeja a la distribución del estadístico sobre el parámetro. 
